...
Upstream: `haiyuan-eng-google/BigQuery-Agent-Analytics-SDK` (`main` @ `b4f320fa7fdd`)
...
### `categorical-eval` (8 exact, 4 semantic mismatch, 1 divergent, 2 missing, 6 dcx-only)
